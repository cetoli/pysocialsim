...
class ReplicateSocialNetworkPeerToPeerMessage(AbstractPeertoPeerMessage):
    
    def __init__(self):
        AbstractPeertoPeerMessage.initialize(self, IPeerToPeerMessage.ADVERTISEMENT, "REPLICATE_SOCIAL_NETWORK", 512*8)