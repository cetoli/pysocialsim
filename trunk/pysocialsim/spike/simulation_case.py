...
from pysocialsim.common.simulator.event.generator.push_opportunity_simulation_event_generator import PushOpportunitySimulationEventGenerator
import pymockobject
...
simulation.addSimulationEventGenerator(NewSuperPeerSimulationEventGenerator(5.5, 1000, 3))
simulation.addSimulationEventGenerator(NewSimplePeerSimulationEventGenerator(5.5, 500, 30))
simulation.addSimulationEventGenerator(SimplePeerLeavingSimulationEventGenerator(1.5618, 6.0013, 30))
simulation.addSimulationEventGenerator(StartOpportunitySimulationventGenerator(1.0, 1000, 10))
simulation.addSimulationEventGenerator(EndOpportunitySimulationEventGenerator(1.5618, 6.0013, 10))
simulation.addSimulationEventGenerator(PushOpportunitySimulationEventGenerator(1000))
simulation.addSimulationEventGenerator(SimplePeerJoiningSimulationEventGenerator(1.8, 3600.0, 30))
