...
network.setConnectionsBetweenSimplePeerAndSuperPeers(6)
...
simulation.addSimulationEventGenerator(NewSuperPeerSimulationEventGenerator(5.5, 28800, 300))
simulation.addSimulationEventGenerator(NewSimplePeerSimulationEventGenerator(5.5, 900, 3000))
simulation.addSimulationEventGenerator(SimplePeerLeavingSimulationEventGenerator(1.5618, 6.0013, 3000))
simulation.addSimulationEventGenerator(StartOpportunitySimulationventGenerator(0.5, 28800, 1))
simulation.addSimulationEventGenerator(EndOpportunitySimulationEventGenerator(1.5618, 6.0013, 1))
simulation.addSimulationEventGenerator(PushOpportunitySimulationEventGenerator(600))
