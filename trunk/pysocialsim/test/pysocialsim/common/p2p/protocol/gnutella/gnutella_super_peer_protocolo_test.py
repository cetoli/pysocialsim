...
class GnutellaSuperPeerProtocolTest(unittest.TestCase):
    ...
    def testJoinSuperPeerInGnutellaNetwork(self):
        ...
        network.getPeer.expects("1").will(ReturnValue(peer1))
        ...
        network.getPeer.expects("2").will(ReturnValue(peer2))
        ...
        peer3.countNeighbors.expects(IPeerToPeerNetwork.SUPER_PEER).will(ReturnValue(0))
        network.getPeer.expects("3").will(ReturnValue(peer3))
        ...
        network.getPeer.expects("4").will(ReturnValue(peer4))
        ...
        network.getPeer.expects("5").will(ReturnValue(peer5))
        ...
        network.getPeer.expects("6").will(ReturnValue(peer6))
    ...
    def testSendPeerToPeerMessageWithThreeHops(self):
        ...
        self.assertEquals(IPeerToPeerProtocol.PUSH, routeMessage.getHandle())
